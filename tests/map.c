...
void fn18(void* env[0]) {
	NUMBER _827 = fn1();
	ANY _828 = box_NUMBER(_827);
	push(_828);
}

void fn17(void* env[0]) {
	ANY _829 = pop();
	NUMBER _830 = unbox_NUMBER(_829);
	NUMBER _831 = fn2(_830);
	ANY _832 = box_NUMBER(_831);
	push(_832);
}

void fn16(void* env[0]) {
	NUMBER _833 = fn3();
	ANY _834 = box_NUMBER(_833);
	push(_834);
}
...
void fn14(void* env[0]) {
	ANY _835 = pop();
	NUMBER _836 = unbox_NUMBER(_835);
	NUMBER _837 = fn5(_836);
	ANY _838 = box_NUMBER(_837);
	push(_838);
}
...
void fn11(void* env[0]) {
	BOX ___x_2 = *(BOX*)&env[0];
	ANY _841 = pop();
	NUMBER _842 = unbox_NUMBER(_841);
	ANY _843 = fn8(___x_2,_842);
	push(_843);
}

void fn10(void* env[0]) {
	NUMBER _844 = fn9();
	ANY _845 = box_NUMBER(_844);
	push(_845);
}
...
NUMBER fn9(void) {
	...
	NUMBER _847 = 3;
	NUMBER _848 = 1;
	ANY _849 = box_NUMBER(_846);
	push(_849);
	ANY _850 = box_NUMBER(_847);
	push(_850);
	return _848;
}

ANY fn8(BOX ___x_2, NUMBER _851) {
	BOX _852 = ___x_2;
	ANY _853 = ___unbox(_852);
	NUMBER _854 = unbox_NUMBER(_853);
	NUMBER _855 = ___P(_854, _851);
	BOX _856 = ___x_2;
	ANY _857 = box_NUMBER(_855);
	___set(_856, _857);
	BOX _858 = ___x_2;
	ANY _859 = ___unbox(_858);
	return _859;
}
...
NUMBER fn7(void) {
	...
	NUMBER _861 = 2;
	NUMBER _862 = 1;
	ANY _863 = box_NUMBER(_860);
	push(_863);
	ANY _864 = box_NUMBER(_861);
	push(_864);
	return _862;
}
...
NUMBER fn5(NUMBER _865) {
	NUMBER _866 = 1;
	NUMBER _867 = ___P(_866, _865);
	return _867;
}
...
NUMBER fn3(void) {
	...
	push(_871);
	ANY _872 = box_NUMBER(_869);
	push(_872);
	return _870;
}

NUMBER fn2(NUMBER _873) {
	NUMBER _874 = 1;
	NUMBER _875 = ___P(_874, _873);
	return _875;
}
...
void fn0(void) {
	BOX ___x_2;
	STRING _881 = "FAIL: Mapping over a list";
	STRING _882 = "PASS: Mapping over a list";
	BLOCK _883 = gc_malloc(3 * WORDSZ);
	_883->fn = fn18;
	LIST _884 = ___list(_883);
	BLOCK _885 = gc_malloc(3 * WORDSZ);
	_885->fn = fn17;
	LIST _886 = ___map(_885, _884);
	BLOCK _887 = gc_malloc(3 * WORDSZ);
	_887->fn = fn16;
	LIST _888 = ___list(_887);
	ANY _889 = box_LIST(_888);
	ANY _890 = box_LIST(_886);
	BOOLEAN _891 = ___EE(_889, _890);
	STRING _892 = _891 ? _882 : _881;
	ANY _893 = box_STRING(_892);
	___print(_893);
	STRING _894 = "FAIL: Mapping over a list";
	STRING _895 = "PASS: Mapping over an empty list";
	BLOCK _896 = gc_malloc(3 * WORDSZ);
	_896->fn = fn15;
	LIST _897 = ___list(_896);
	BLOCK _898 = gc_malloc(3 * WORDSZ);
	_898->fn = fn14;
	LIST _899 = ___map(_898, _897);
	BLOCK _900 = gc_malloc(3 * WORDSZ);
	_900->fn = fn13;
	LIST _901 = ___list(_900);
	ANY _902 = box_LIST(_901);
	ANY _903 = box_LIST(_899);
	BOOLEAN _904 = ___EE(_902, _903);
	STRING _905 = _904 ? _895 : _894;
	ANY _906 = box_STRING(_905);
	___print(_906);
	NUMBER _907 = 0;
	ANY _908 = box_NUMBER(_907);
	BOX _909 = ___box(_908);
	___x_2 = _909;
	STRING _910 = "FAIL: Mapping in order";
	STRING _911 = "PASS: Mapping in order";
	BLOCK _912 = gc_malloc(3 * WORDSZ);
	_912->fn = fn12;
	LIST _913 = ___list(_912);
	BLOCK _914 = gc_malloc(4 * WORDSZ);
	_914->fn = fn11;
	_914->env[0] = *(void**)&___x_2;
	LIST _915 = ___map(_914, _913);
	BLOCK _916 = gc_malloc(3 * WORDSZ);
	_916->fn = fn10;
	LIST _917 = ___list(_916);
	ANY _918 = box_LIST(_917);
	ANY _919 = box_LIST(_915);
	BOOLEAN _920 = ___EE(_918, _919);
	STRING _921 = _920 ? _911 : _910;

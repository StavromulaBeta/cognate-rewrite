...
void fn0(void) {
	STRING _790 = "FAIL: Addition";
	STRING _791 = "PASS: Addition";
	NUMBER _792 = 6;
	NUMBER _793 = 5;
	NUMBER _794 = ___P(_793, _792);
	NUMBER _795 = 11;
	ANY _796 = box_NUMBER(_795);
	ANY _797 = box_NUMBER(_794);
	BOOLEAN _798 = ___EE(_796, _797);
	STRING _799 = _798 ? _791 : _790;
	ANY _800 = box_STRING(_799);
	___print(_800);
	STRING _801 = "FAIL: Subtraction";
	STRING _802 = "PASS: Subtraction";
	NUMBER _803 = 19;
	NUMBER _804 = 10;
	NUMBER _805 = ___D(_804, _803);
	NUMBER _806 = 9;
	ANY _807 = box_NUMBER(_806);
	ANY _808 = box_NUMBER(_805);
	BOOLEAN _809 = ___EE(_807, _808);
	STRING _810 = _809 ? _802 : _801;
	ANY _811 = box_STRING(_810);
	___print(_811);
	STRING _812 = "FAIL: Multiplication";
	STRING _813 = "PASS: Multiplication";
	NUMBER _814 = 8;
	NUMBER _815 = 9;
	NUMBER _816 = ___M(_815, _814);
	NUMBER _817 = 72;
	ANY _818 = box_NUMBER(_817);
	ANY _819 = box_NUMBER(_816);
	BOOLEAN _820 = ___EE(_818, _819);
	STRING _821 = _820 ? _813 : _812;
	ANY _822 = box_STRING(_821);
	___print(_822);
	STRING _823 = "FAIL: Division";
	STRING _824 = "PASS: Division";
	NUMBER _825 = 42;
	NUMBER _826 = 7;
	NUMBER _827 = ___S(_826, _825);
	NUMBER _828 = 6;
	ANY _829 = box_NUMBER(_828);
	ANY _830 = box_NUMBER(_827);
	BOOLEAN _831 = ___EE(_829, _830);
	STRING _832 = _831 ? _824 : _823;
	ANY _833 = box_STRING(_832);
	___print(_833);
	STRING _834 = "FAIL: Modulus";
	STRING _835 = "PASS: Modulus";
	NUMBER _836 = 10;
	NUMBER _837 = 3;
	NUMBER _838 = ___modulo(_837, _836);
	NUMBER _839 = 1;
	ANY _840 = box_NUMBER(_839);
	ANY _841 = box_NUMBER(_838);
	BOOLEAN _842 = ___EE(_840, _841);
	STRING _843 = _842 ? _835 : _834;
	ANY _844 = box_STRING(_843);
	___print(_844);
	STRING _845 = "FAIL: Floor";
	STRING _846 = "PASS: Floor";
	NUMBER _847 = 4.7;
	NUMBER _848 = ___floor(_847);
	NUMBER _849 = 4;
	ANY _850 = box_NUMBER(_849);
	ANY _851 = box_NUMBER(_848);
	BOOLEAN _852 = ___EE(_850, _851);
	STRING _853 = _852 ? _846 : _845;
	ANY _854 = box_STRING(_853);
	___print(_854);
	STRING _855 = "FAIL: Ceiling";
	STRING _856 = "PASS: Ceiling";
	NUMBER _857 = 4.3;
	NUMBER _858 = ___ceiling(_857);
	NUMBER _859 = 5;
	ANY _860 = box_NUMBER(_859);
	ANY _861 = box_NUMBER(_858);
	BOOLEAN _862 = ___EE(_860, _861);
	STRING _863 = _862 ? _856 : _855;
	ANY _864 = box_STRING(_863);
	___print(_864);
	STRING _865 = "FAIL: Round";
	STRING _866 = "PASS: Round";
	NUMBER _867 = 4.7;
	NUMBER _868 = ___round(_867);
	NUMBER _869 = 5;
	ANY _870 = box_NUMBER(_869);
	ANY _871 = box_NUMBER(_868);
	BOOLEAN _872 = ___EE(_870, _871);
	STRING _873 = _872 ? _866 : _865;
	ANY _874 = box_STRING(_873);
	___print(_874);
	STRING _875 = "FAIL: Floating point error";
	STRING _876 = "PASS: Floating point error";
	NUMBER _877 = 0.2;
	NUMBER _878 = 0.1;
	NUMBER _879 = ___P(_878, _877);
	NUMBER _880 = 0.3;
	ANY _881 = box_NUMBER(_880);
	ANY _882 = box_NUMBER(_879);
	BOOLEAN _883 = ___EE(_881, _882);
	STRING _884 = _883 ? _876 : _875;
	ANY _885 = box_STRING(_884);
	___print(_885);
	STRING _886 = "FAIL: Floating point error 2";
	STRING _887 = "PASS: Floating point error 2";
	NUMBER _888 = 0.3;
	NUMBER _889 = 3;
	NUMBER _890 = ___M(_889, _888);
	NUMBER _891 = 0.1;
	NUMBER _892 = ___P(_891, _890);
	NUMBER _893 = 1;
	ANY _894 = box_NUMBER(_893);
	ANY _895 = box_NUMBER(_892);
	BOOLEAN _896 = ___EE(_894, _895);
	STRING _897 = _896 ? _887 : _886;
	ANY _898 = box_STRING(_897);
	___print(_898);
}

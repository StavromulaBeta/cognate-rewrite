...
void fn0(void) {
	STRING _120 = "FAIL: Comparing different symbols";
	STRING _121 = "PASS: Comparing different symbols";
	SYMBOL _122 = SYMbar;
	SYMBOL _123 = SYMfoo;
	ANY _124 = box_SYMBOL(_123);
	ANY _125 = box_SYMBOL(_122);
	BOOLEAN _126 = ___XE(_124, _125);
	STRING _127 = _126 ? _121 : _120;
	ANY _128 = box_STRING(_127);
	___print(_128);
	STRING _129 = "FAIL: Comparing the same symbol";
	STRING _130 = "PASS: Comparing the same symbol";
	SYMBOL _131 = SYMfoo;
	SYMBOL _132 = SYMfoo;
	ANY _133 = box_SYMBOL(_132);
	ANY _134 = box_SYMBOL(_131);
	BOOLEAN _135 = ___EE(_133, _134);
	STRING _136 = _135 ? _130 : _129;
	ANY _137 = box_STRING(_136);
	___print(_137);
}

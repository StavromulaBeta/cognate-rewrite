...
void fn0(void) {
	STRING _1370 = "FAIL: Degree sin";
	STRING _1371 = "PASS: Degree sin";
	NUMBER _1372 = 90;
	NUMBER _1373 = ___sind(_1372);
	NUMBER _1374 = 1;
	ANY _1375 = box_NUMBER(_1374);
	ANY _1376 = box_NUMBER(_1373);
	BOOLEAN _1377 = ___EE(_1375, _1376);
	STRING _1378 = _1377 ? _1371 : _1370;
	ANY _1379 = box_STRING(_1378);
	___print(_1379);
	STRING _1380 = "FAIL: Degree cos";
	STRING _1381 = "PASS: Degree cos";
	NUMBER _1382 = 360;
	NUMBER _1383 = ___cosd(_1382);
	NUMBER _1384 = 1;
	ANY _1385 = box_NUMBER(_1384);
	ANY _1386 = box_NUMBER(_1383);
	BOOLEAN _1387 = ___EE(_1385, _1386);
	STRING _1388 = _1387 ? _1381 : _1380;
	ANY _1389 = box_STRING(_1388);
	___print(_1389);
	STRING _1390 = "FAIL: Degree tan";
	STRING _1391 = "PASS: Degree tan";
	NUMBER _1392 = 90;
	NUMBER _1393 = ___tand(_1392);
	NUMBER _1394 = 90;
	NUMBER _1395 = ___sind(_1394);
	NUMBER _1396 = 90;
	NUMBER _1397 = ___cosd(_1396);
	NUMBER _1398 = ___S(_1397, _1395);
	ANY _1399 = box_NUMBER(_1398);
	ANY _1400 = box_NUMBER(_1393);
	BOOLEAN _1401 = ___EE(_1399, _1400);
	STRING _1402 = _1401 ? _1391 : _1390;
	ANY _1403 = box_STRING(_1402);
	___print(_1403);
	STRING _1404 = "FAIL: Radian sin";
	STRING _1405 = "PASS: Radian sin";
	NUMBER _1406 = 3.14159265358979323846;
	NUMBER _1407 = 2;
	NUMBER _1408 = ___S(_1407, _1406);
	NUMBER _1409 = ___sin(_1408);
	NUMBER _1410 = 1;
	ANY _1411 = box_NUMBER(_1410);
	ANY _1412 = box_NUMBER(_1409);
	BOOLEAN _1413 = ___EE(_1411, _1412);
	STRING _1414 = _1413 ? _1405 : _1404;
	ANY _1415 = box_STRING(_1414);
	___print(_1415);
	STRING _1416 = "FAIL: Radian cos";
	STRING _1417 = "PASS: Radian cos";
	NUMBER _1418 = 0;
	NUMBER _1419 = ___cos(_1418);
	NUMBER _1420 = 1;
	ANY _1421 = box_NUMBER(_1420);
	ANY _1422 = box_NUMBER(_1419);
	BOOLEAN _1423 = ___EE(_1421, _1422);
	STRING _1424 = _1423 ? _1417 : _1416;
	ANY _1425 = box_STRING(_1424);
	___print(_1425);
	STRING _1426 = "FAIL: Radian tan";
	STRING _1427 = "PASS: Radian tan";
	NUMBER _1428 = 90;
	NUMBER _1429 = ___tan(_1428);
	NUMBER _1430 = 90;
	NUMBER _1431 = ___sin(_1430);
	NUMBER _1432 = 90;
	NUMBER _1433 = ___cos(_1432);
	NUMBER _1434 = ___S(_1433, _1431);
	ANY _1435 = box_NUMBER(_1434);
	ANY _1436 = box_NUMBER(_1429);
	BOOLEAN _1437 = ___EE(_1435, _1436);
	STRING _1438 = _1437 ? _1427 : _1426;
	ANY _1439 = box_STRING(_1438);
	___print(_1439);
	STRING _1440 = "FAIL: Degree arcsin";
	STRING _1441 = "PASS: Degree arcsin";
	NUMBER _1442 = 0.5;
	NUMBER _1443 = ___asind(_1442);
	NUMBER _1444 = 30;
	ANY _1445 = box_NUMBER(_1444);
	ANY _1446 = box_NUMBER(_1443);
	BOOLEAN _1447 = ___EE(_1445, _1446);
	STRING _1448 = _1447 ? _1441 : _1440;
	ANY _1449 = box_STRING(_1448);
	___print(_1449);
	STRING _1450 = "FAIL: Degree arccos";
	STRING _1451 = "PASS: Degree arccos";
	NUMBER _1452 = 0.5;
	NUMBER _1453 = ___acosd(_1452);
	NUMBER _1454 = 60;
	ANY _1455 = box_NUMBER(_1454);
	ANY _1456 = box_NUMBER(_1453);
	BOOLEAN _1457 = ___EE(_1455, _1456);
	STRING _1458 = _1457 ? _1451 : _1450;
	ANY _1459 = box_STRING(_1458);
	___print(_1459);
	STRING _1460 = "FAIL: Degree arctan";
	STRING _1461 = "PASS: Degree arctan";
	NUMBER _1462 = 0.5;
	NUMBER _1463 = ___atand(_1462);
	NUMBER _1464 = 26.565051177078;
	ANY _1465 = box_NUMBER(_1464);
	ANY _1466 = box_NUMBER(_1463);
	BOOLEAN _1467 = ___EE(_1465, _1466);
	STRING _1468 = _1467 ? _1461 : _1460;
	ANY _1469 = box_STRING(_1468);
	___print(_1469);
	STRING _1470 = "FAIL: Radian arcsin";
	STRING _1471 = "PASS: Radian arcsin";
	NUMBER _1472 = 0.5;
	NUMBER _1473 = ___asin(_1472);
	NUMBER _1474 = 0.5235987755983;
	ANY _1475 = box_NUMBER(_1474);
	ANY _1476 = box_NUMBER(_1473);
	BOOLEAN _1477 = ___EE(_1475, _1476);
	STRING _1478 = _1477 ? _1471 : _1470;
	ANY _1479 = box_STRING(_1478);
	___print(_1479);
	STRING _1480 = "FAIL: Radian arccos";
	STRING _1481 = "PASS: Radian arccos";
	NUMBER _1482 = 0.5;
	NUMBER _1483 = ___acos(_1482);
	NUMBER _1484 = 1.0471975511966;
	ANY _1485 = box_NUMBER(_1484);
	ANY _1486 = box_NUMBER(_1483);
	BOOLEAN _1487 = ___EE(_1485, _1486);
	STRING _1488 = _1487 ? _1481 : _1480;
	ANY _1489 = box_STRING(_1488);
	___print(_1489);
	STRING _1490 = "FAIL: Radian arctan";
	STRING _1491 = "PASS: Radian arctan";
	NUMBER _1492 = 10;
	NUMBER _1493 = ___atan(_1492);
	NUMBER _1494 = ___tan(_1493);
	NUMBER _1495 = 10;
	ANY _1496 = box_NUMBER(_1495);
	ANY _1497 = box_NUMBER(_1494);
	BOOLEAN _1498 = ___EE(_1496, _1497);
	STRING _1499 = _1498 ? _1491 : _1490;
	ANY _1500 = box_STRING(_1499);
	___print(_1500);
	STRING _1501 = "FAIL: Degree hyperbolic sin";
	STRING _1502 = "PASS: Degree hyperbolic sin";
	NUMBER _1503 = 0;
	NUMBER _1504 = ___sinhd(_1503);
	NUMBER _1505 = 0;
	ANY _1506 = box_NUMBER(_1505);
	ANY _1507 = box_NUMBER(_1504);
	BOOLEAN _1508 = ___EE(_1506, _1507);
	STRING _1509 = _1508 ? _1502 : _1501;
	ANY _1510 = box_STRING(_1509);
	___print(_1510);
	STRING _1511 = "FAIL: Degree hyperbolic cos";
	STRING _1512 = "PASS: Degree hyperbolic cos";
	NUMBER _1513 = 1;
	NUMBER _1514 = ___coshd(_1513);
	NUMBER _1515 = 88.412007823281300034068408422172;
	ANY _1516 = box_NUMBER(_1515);
	ANY _1517 = box_NUMBER(_1514);
	BOOLEAN _1518 = ___EE(_1516, _1517);
	STRING _1519 = _1518 ? _1512 : _1511;
	ANY _1520 = box_STRING(_1519);
	___print(_1520);
	STRING _1521 = "FAIL: Degree hyperbolic tan";
	STRING _1522 = "PASS: Degree hyperbolic tan";
	NUMBER _1523 = 0;
	NUMBER _1524 = ___tanhd(_1523);
	NUMBER _1525 = 0;
	ANY _1526 = box_NUMBER(_1525);
	ANY _1527 = box_NUMBER(_1524);
	BOOLEAN _1528 = ___EE(_1526, _1527);
	STRING _1529 = _1528 ? _1522 : _1521;
	ANY _1530 = box_STRING(_1529);
	___print(_1530);
	STRING _1531 = "FAIL: Radian hyperbolic sin";
	STRING _1532 = "PASS: Radian hyperbolic sin";
	NUMBER _1533 = 0;
	NUMBER _1534 = ___sinh(_1533);
	NUMBER _1535 = 0;
	ANY _1536 = box_NUMBER(_1535);
	ANY _1537 = box_NUMBER(_1534);
	BOOLEAN _1538 = ___EE(_1536, _1537);
	STRING _1539 = _1538 ? _1532 : _1531;
	ANY _1540 = box_STRING(_1539);
	___print(_1540);
	STRING _1541 = "FAIL: Radian hyperbolic cos";
	STRING _1542 = "PASS: Radian hyperbolic cos";
	NUMBER _1543 = 0;
	NUMBER _1544 = ___cosh(_1543);
	NUMBER _1545 = 1;
	ANY _1546 = box_NUMBER(_1545);
	ANY _1547 = box_NUMBER(_1544);
	BOOLEAN _1548 = ___EE(_1546, _1547);
	STRING _1549 = _1548 ? _1542 : _1541;
	ANY _1550 = box_STRING(_1549);
	___print(_1550);
	STRING _1551 = "FAIL: Radian hyperbolic tan";
	STRING _1552 = "PASS: Radian hyperbolic tan";
	NUMBER _1553 = 0;
	NUMBER _1554 = ___tanh(_1553);
	NUMBER _1555 = 0;
	ANY _1556 = box_NUMBER(_1555);
	ANY _1557 = box_NUMBER(_1554);
	BOOLEAN _1558 = ___EE(_1556, _1557);
	STRING _1559 = _1558 ? _1552 : _1551;
	ANY _1560 = box_STRING(_1559);
	___print(_1560);
}

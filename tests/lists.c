...
void fn24(void* env[0]);
void fn23(void* env[0]);
void fn22(void* env[0]);
void fn21(void* env[0]);
void fn20(void* env[0]);
void fn19(void* env[0]);
void fn18(void* env[0]);
void fn17(void* env[0]);
void fn16(void* env[0]);
void fn15(void* env[0]);
void fn14(void* env[0]);
void fn13(void* env[0]);
NUMBER fn12(void);
NUMBER fn11(void);
void fn10(void);
NUMBER fn9(void);
...
void fn19(void* env[0]) {
	NUMBER _1468 = fn6();
	ANY _1469 = box_NUMBER(_1468);
	push(_1469);
}

void fn18(void* env[0]) {
	NUMBER _1470 = fn7();
	ANY _1471 = box_NUMBER(_1470);
	push(_1471);
}

void fn17(void* env[0]) {
	NUMBER _1472 = fn8();
	ANY _1473 = box_NUMBER(_1472);
	push(_1473);
}
...
void fn14(void* env[0]) {
	NUMBER _1476 = fn11();
	ANY _1477 = box_NUMBER(_1476);
	push(_1477);
}

void fn13(void* env[0]) {
	NUMBER _1478 = fn12();
	ANY _1479 = box_NUMBER(_1478);
	push(_1479);
}
...
NUMBER fn12(void) {
	...
	NUMBER _1481 = 2;
	NUMBER _1482 = 1;
	ANY _1483 = box_NUMBER(_1480);
	push(_1483);
	ANY _1484 = box_NUMBER(_1481);
	push(_1484);
	return _1482;
}
...
NUMBER fn11(void) {
	...
	NUMBER _1488 = 2;
	NUMBER _1489 = 1;
	ANY _1490 = box_NUMBER(_1485);
	push(_1490);
	ANY _1491 = box_NUMBER(_1486);
	push(_1491);
	ANY _1492 = box_NUMBER(_1487);
	push(_1492);
	ANY _1493 = box_NUMBER(_1488);
	push(_1493);
	return _1489;
}
...
NUMBER fn6(void) {
	...
	NUMBER _1501 = 1;
	NUMBER _1502 = 42;
	ANY _1503 = box_NUMBER(_1499);
	push(_1503);
	ANY _1504 = box_NUMBER(_1500);
	push(_1504);
	ANY _1505 = box_NUMBER(_1501);
	push(_1505);
	return _1502;
}
...
NUMBER fn2(void) {
	...
	NUMBER _1507 = 6;
	NUMBER _1508 = 5;
	ANY _1509 = box_NUMBER(_1506);
	push(_1509);
	ANY _1510 = box_NUMBER(_1507);
	push(_1510);
	return _1508;
}
...
NUMBER fn1(void) {
	...
	NUMBER _1512 = 2;
	NUMBER _1513 = 1;
	ANY _1514 = box_NUMBER(_1511);
	push(_1514);
	ANY _1515 = box_NUMBER(_1512);
	push(_1515);
	return _1513;
}
...
void fn0(void) {
	LIST ___foo_2;
	BLOCK _1516 = gc_malloc(3 * WORDSZ);
	_1516->fn = fn24;
	LIST _1517 = ___list(_1516);
	___foo_2 = _1517;
	STRING _1518 = "FAIL: Comparing equal lists";
	STRING _1519 = "PASS: Comparing equal lists";
	LIST _1520 = ___foo_2;
	LIST _1521 = ___foo_2;
	ANY _1522 = box_LIST(_1521);
	ANY _1523 = box_LIST(_1520);
	BOOLEAN _1524 = ___EE(_1522, _1523);
	STRING _1525 = _1524 ? _1519 : _1518;
	ANY _1526 = box_STRING(_1525);
	___print(_1526);
	STRING _1527 = "FAIL: Comparing unequal lists";
	STRING _1528 = "PASS: Comparing unequal lists";
	BLOCK _1529 = gc_malloc(3 * WORDSZ);
	_1529->fn = fn23;
	LIST _1530 = ___list(_1529);
	LIST _1531 = ___foo_2;
	ANY _1532 = box_LIST(_1531);
	ANY _1533 = box_LIST(_1530);
	BOOLEAN _1534 = ___XE(_1532, _1533);
	STRING _1535 = _1534 ? _1528 : _1527;
	ANY _1536 = box_STRING(_1535);
	___print(_1536);
	STRING _1537 = "FAIL: Comparing two empty lists";
	STRING _1538 = "PASS: Comparing two empty lists";
	BLOCK _1539 = gc_malloc(3 * WORDSZ);
	_1539->fn = fn22;
	LIST _1540 = ___list(_1539);
	BLOCK _1541 = gc_malloc(3 * WORDSZ);
	_1541->fn = fn21;
	LIST _1542 = ___list(_1541);
	ANY _1543 = box_LIST(_1542);
	ANY _1544 = box_LIST(_1540);
	BOOLEAN _1545 = ___EE(_1543, _1544);
	STRING _1546 = _1545 ? _1538 : _1537;
	ANY _1547 = box_STRING(_1546);
	___print(_1547);
	STRING _1548 = "FAIL: An empty list to a non-empty list";
	STRING _1549 = "PASS: An empty list to a non-empty list";
	LIST _1550 = ___foo_2;
	BLOCK _1551 = gc_malloc(3 * WORDSZ);
	_1551->fn = fn20;
	LIST _1552 = ___list(_1551);
	ANY _1553 = box_LIST(_1552);
	ANY _1554 = box_LIST(_1550);
	BOOLEAN _1555 = ___XE(_1553, _1554);
	STRING _1556 = _1555 ? _1549 : _1548;
	ANY _1557 = box_STRING(_1556);
	___print(_1557);
	STRING _1558 = "FAIL: Pushing object to list";
	STRING _1559 = "PASS: Pushing object to list";
	BLOCK _1560 = gc_malloc(3 * WORDSZ);
	_1560->fn = fn19;
	LIST _1561 = ___list(_1560);
	LIST _1562 = ___foo_2;
	NUMBER _1563 = 42;
	ANY _1564 = box_NUMBER(_1563);
	LIST _1565 = ___push(_1564, _1562);
	ANY _1566 = box_LIST(_1565);
	ANY _1567 = box_LIST(_1561);
	BOOLEAN _1568 = ___EE(_1566, _1567);
	STRING _1569 = _1568 ? _1559 : _1558;
	ANY _1570 = box_STRING(_1569);
	___print(_1570);
	STRING _1571 = "FAIL: Getting First element in list";
	STRING _1572 = "PASS: Getting First element in list";
	LIST _1573 = ___foo_2;
	ANY _1574 = ___first(_1573);
	NUMBER _1575 = 1;
	ANY _1576 = box_NUMBER(_1575);
	BOOLEAN _1577 = ___EE(_1576, _1574);
	STRING _1578 = _1577 ? _1572 : _1571;
	ANY _1579 = box_STRING(_1578);
	___print(_1579);
	STRING _1580 = "FAIL: Getting First element in single-element list";
	STRING _1581 = "PASS: Getting First element in single-element list";
	BLOCK _1582 = gc_malloc(3 * WORDSZ);
	_1582->fn = fn18;
	LIST _1583 = ___list(_1582);
	ANY _1584 = ___first(_1583);
	NUMBER _1585 = 1;
	ANY _1586 = box_NUMBER(_1585);
	BOOLEAN _1587 = ___EE(_1586, _1584);
	STRING _1588 = _1587 ? _1581 : _1580;
	ANY _1589 = box_STRING(_1588);
	___print(_1589);
	STRING _1590 = "FAIL: Getting Rest of list";
	STRING _1591 = "PASS: Getting Rest of list";
	BLOCK _1592 = gc_malloc(3 * WORDSZ);
	_1592->fn = fn17;
	LIST _1593 = ___list(_1592);
	LIST _1594 = ___foo_2;
	LIST _1595 = ___rest(_1594);
	ANY _1596 = box_LIST(_1595);
	ANY _1597 = box_LIST(_1593);
	BOOLEAN _1598 = ___EE(_1596, _1597);
	STRING _1599 = _1598 ? _1591 : _1590;
	ANY _1600 = box_STRING(_1599);
	___print(_1600);
	STRING _1601 = "FAIL: Getting Rest of single-element list";
	STRING _1602 = "PASS: Getting Rest of single-element list";
	BLOCK _1603 = gc_malloc(3 * WORDSZ);
	_1603->fn = fn16;
	LIST _1604 = ___list(_1603);
	LIST _1605 = ___rest(_1604);
	BLOCK _1606 = gc_malloc(3 * WORDSZ);
	_1606->fn = fn15;
	LIST _1607 = ___list(_1606);
	ANY _1608 = box_LIST(_1607);
	ANY _1609 = box_LIST(_1605);
	BOOLEAN _1610 = ___EE(_1608, _1609);
	STRING _1611 = _1610 ? _1602 : _1601;
	ANY _1612 = box_STRING(_1611);
	___print(_1612);
	STRING _1613 = "FAIL: Getting index of list";
	STRING _1614 = "PASS: Getting index of list";
	BLOCK _1615 = gc_malloc(3 * WORDSZ);
	_1615->fn = fn14;
	LIST _1616 = ___list(_1615);
	NUMBER _1617 = 3;
	ANY _1618 = ___index(_1617, _1616);
	NUMBER _1619 = 4;
	ANY _1620 = box_NUMBER(_1619);
	BOOLEAN _1621 = ___EE(_1620, _1618);
	STRING _1622 = _1621 ? _1614 : _1613;
	ANY _1623 = box_STRING(_1622);
	___print(_1623);
	STRING _1624 = "FAIL: Getting length of list";
	STRING _1625 = "PASS: Getting length of list";
	BLOCK _1626 = gc_malloc(3 * WORDSZ);
	_1626->fn = fn13;
	LIST _1627 = ___list(_1626);
	NUMBER _1628 = ___length(_1627);
	NUMBER _1629 = 3;
	ANY _1630 = box_NUMBER(_1629);
	ANY _1631 = box_NUMBER(_1628);
	BOOLEAN _1632 = ___EE(_1630, _1631);
	STRING _1633 = _1632 ? _1625 : _1624;
	ANY _1634 = box_STRING(_1633);
	___print(_1634);
}

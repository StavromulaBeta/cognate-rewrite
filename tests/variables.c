...
void fn1(void) {
	STRING _251 = "FAIL: Variable shadowing";
	STRING _252 = "PASS: Variable shadowing";
	NUMBER _253 = 2;
	NUMBER _254 = 2;
	ANY _255 = box_NUMBER(_254);
	ANY _256 = box_NUMBER(_253);
	BOOLEAN _257 = ___EE(_255, _256);
	STRING _258 = _257 ? _252 : _251;
	ANY _259 = box_STRING(_258);
	___print(_259);
}

void fn0(void) {
	STRING _260 = "FAIL: Variable assignment";
	STRING _261 = "PASS: Variable assignment";
	NUMBER _262 = 1;
	NUMBER _263 = 1;
	ANY _264 = box_NUMBER(_263);
	ANY _265 = box_NUMBER(_262);
	BOOLEAN _266 = ___EE(_264, _265);
	STRING _267 = _266 ? _261 : _260;
	ANY _268 = box_STRING(_267);
	___print(_268);
	BLOCK _269 = gc_malloc(3 * WORDSZ);
	_269->fn = fn2;
	___do(_269);
	STRING _270 = "FAIL: Variable shadowing in block";
	STRING _271 = "PASS: Variable shadowing in block";
	NUMBER _272 = 1;
	NUMBER _273 = 1;
	ANY _274 = box_NUMBER(_273);
	ANY _275 = box_NUMBER(_272);
	BOOLEAN _276 = ___EE(_274, _275);
	STRING _277 = _276 ? _271 : _270;
	ANY _278 = box_STRING(_277);
	___print(_278);
}

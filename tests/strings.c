...
STRING fn1(void) {
	STRING _857 = "world!";
	STRING _858 = "Hello";
	ANY _859 = box_STRING(_857);
	push(_859);
	return _858;
}

void fn0(void) {
	STRING _860 = "FAIL: Converting list of characters to combined string";
	STRING _861 = "PASS: Converting list of strings to combined string";
	STRING _862 = " ☺";
	STRING _863 = " world";
	STRING _864 = "Hello";
	STRING _865 = ___join(_864, _863);
	STRING _866 = ___join(_865, _862);
	STRING _867 = "Hello world ☺";
	ANY _868 = box_STRING(_867);
	ANY _869 = box_STRING(_866);
	BOOLEAN _870 = ___EE(_868, _869);
	STRING _871 = _870 ? _861 : _860;
	ANY _872 = box_STRING(_871);
	___print(_872);
	STRING _873 = "PASS: Converting string to UTF8 value with Ordinal";
	STRING _874 = "PASS: Converting string to UTF8 value with Ordinal";
	STRING _875 = "☺";
	NUMBER _876 = ___ordinal(_875);
	NUMBER _877 = 9786;
	ANY _878 = box_NUMBER(_877);
	ANY _879 = box_NUMBER(_876);
	BOOLEAN _880 = ___EE(_878, _879);
	STRING _881 = _880 ? _874 : _873;
	ANY _882 = box_STRING(_881);
	___print(_882);
	STRING _883 = "FAIL: Converting UTF8 value to string";
	STRING _884 = "PASS: Converting UTF8 value to string";
	NUMBER _885 = 9786;
	STRING _886 = ___character(_885);
	STRING _887 = "☺";
	ANY _888 = box_STRING(_887);
	ANY _889 = box_STRING(_886);
	BOOLEAN _890 = ___EE(_888, _889);
	STRING _891 = _890 ? _884 : _883;
	ANY _892 = box_STRING(_891);
	___print(_892);
	STRING _893 = "PASS: Casting strings to numbers";
	STRING _894 = "PASS: Casting strings to numbers";
	STRING _895 = "123.4";
	NUMBER _896 = ___number(_895);
	NUMBER _897 = 123.4;
	ANY _898 = box_NUMBER(_897);
	ANY _899 = box_NUMBER(_896);
	BOOLEAN _900 = ___EE(_898, _899);
	STRING _901 = _900 ? _894 : _893;
	ANY _902 = box_STRING(_901);
	___print(_902);
	STRING _903 = "FAIL: Getting Head of string";
	STRING _904 = "PASS: Getting Head of string";
	STRING _905 = "Hello";
	STRING _906 = ___head(_905);
	STRING _907 = "H";
	ANY _908 = box_STRING(_907);
	ANY _909 = box_STRING(_906);
	BOOLEAN _910 = ___EE(_908, _909);
	STRING _911 = _910 ? _904 : _903;
	ANY _912 = box_STRING(_911);
	___print(_912);
	STRING _913 = "FAIL: Getting Head of single-character string";
	STRING _914 = "PASS: Getting Head of single-character string";
	STRING _915 = "e";
	STRING _916 = ___head(_915);
	STRING _917 = "e";
	ANY _918 = box_STRING(_917);
	ANY _919 = box_STRING(_916);
	BOOLEAN _920 = ___EE(_918, _919);
	STRING _921 = _920 ? _914 : _913;
	ANY _922 = box_STRING(_921);
	___print(_922);
	STRING _923 = "FAIL: Getting Tail of string";
	STRING _924 = "PASS: Getting Tail of string";
	STRING _925 = "Hello";
	STRING _926 = ___tail(_925);
	STRING _927 = "ello";
	ANY _928 = box_STRING(_927);
	ANY _929 = box_STRING(_926);
	BOOLEAN _930 = ___EE(_928, _929);
	STRING _931 = _930 ? _924 : _923;
	ANY _932 = box_STRING(_931);
	___print(_932);
	STRING _933 = "FAIL: Getting Tail of single-character string";
	STRING _934 = "PASS: Getting Tail of single-character string";
	STRING _935 = "e";
	STRING _936 = ___tail(_935);
	STRING _937 = "";
	ANY _938 = box_STRING(_937);
	ANY _939 = box_STRING(_936);
	BOOLEAN _940 = ___EE(_938, _939);
	STRING _941 = _940 ? _934 : _933;
	ANY _942 = box_STRING(_941);
	___print(_942);
	STRING _943 = "FAIL: Splitting a string";
	STRING _944 = "PASS: Splitting a string";
	STRING _945 = "Hello world!";
	STRING _946 = " ";
	LIST _947 = ___split(_946, _945);
	BLOCK _948 = gc_malloc(3 * WORDSZ);
	_948->fn = fn2;
	LIST _949 = ___list(_948);
	ANY _950 = box_LIST(_949);
	ANY _951 = box_LIST(_947);
	BOOLEAN _952 = ___EE(_950, _951);
	STRING _953 = _952 ? _944 : _943;
	ANY _954 = box_STRING(_953);
	___print(_954);
}

...
void fn0(void) {
	STRING _1060 = "FAIL: True == True";
	STRING _1061 = "PASS: True == True";
	BOOLEAN _1062 = ___true();
	BOOLEAN _1063 = ___true();
	ANY _1064 = box_BOOLEAN(_1063);
	ANY _1065 = box_BOOLEAN(_1062);
	BOOLEAN _1066 = ___EE(_1064, _1065);
	STRING _1067 = _1066 ? _1061 : _1060;
	ANY _1068 = box_STRING(_1067);
	___print(_1068);
	STRING _1069 = "FAIL: False == False";
	STRING _1070 = "PASS: False == False";
	BOOLEAN _1071 = ___false();
	BOOLEAN _1072 = ___false();
	ANY _1073 = box_BOOLEAN(_1072);
	ANY _1074 = box_BOOLEAN(_1071);
	BOOLEAN _1075 = ___EE(_1073, _1074);
	STRING _1076 = _1075 ? _1070 : _1069;
	ANY _1077 = box_STRING(_1076);
	___print(_1077);
	STRING _1078 = "PASS: True == False";
	STRING _1079 = "Fail: True == False";
	BOOLEAN _1080 = ___false();
	BOOLEAN _1081 = ___true();
	ANY _1082 = box_BOOLEAN(_1081);
	ANY _1083 = box_BOOLEAN(_1080);
	BOOLEAN _1084 = ___EE(_1082, _1083);
	STRING _1085 = _1084 ? _1079 : _1078;
	ANY _1086 = box_STRING(_1085);
	___print(_1086);
	STRING _1087 = "PASS: False == True";
	STRING _1088 = "Fail: False == True";
	BOOLEAN _1089 = ___true();
	BOOLEAN _1090 = ___false();
	ANY _1091 = box_BOOLEAN(_1090);
	ANY _1092 = box_BOOLEAN(_1089);
	BOOLEAN _1093 = ___EE(_1091, _1092);
	STRING _1094 = _1093 ? _1088 : _1087;
	ANY _1095 = box_STRING(_1094);
	___print(_1095);
	STRING _1096 = "FAIL: True AND True";
	STRING _1097 = "PASS: True AND True";
	BOOLEAN _1098 = ___true();
	BOOLEAN _1099 = ___true();
	BOOLEAN _1100 = ___and(_1099, _1098);
	STRING _1101 = _1100 ? _1097 : _1096;
	ANY _1102 = box_STRING(_1101);
	___print(_1102);
	STRING _1103 = "PASS: True AND False";
	STRING _1104 = "FAIL: True AND False";
	BOOLEAN _1105 = ___false();
	BOOLEAN _1106 = ___true();
	BOOLEAN _1107 = ___and(_1106, _1105);
	STRING _1108 = _1107 ? _1104 : _1103;
	ANY _1109 = box_STRING(_1108);
	___print(_1109);
	STRING _1110 = "PASS: False AND True";
	STRING _1111 = "FAIL: False AND True";
	BOOLEAN _1112 = ___true();
	BOOLEAN _1113 = ___false();
	BOOLEAN _1114 = ___and(_1113, _1112);
	STRING _1115 = _1114 ? _1111 : _1110;
	ANY _1116 = box_STRING(_1115);
	___print(_1116);
	STRING _1117 = "PASS: False AND False";
	STRING _1118 = "FAIL: False AND False";
	BOOLEAN _1119 = ___false();
	BOOLEAN _1120 = ___false();
	BOOLEAN _1121 = ___and(_1120, _1119);
	STRING _1122 = _1121 ? _1118 : _1117;
	ANY _1123 = box_STRING(_1122);
	___print(_1123);
	STRING _1124 = "FAIL: True OR True";
	STRING _1125 = "PASS: True OR True";
	BOOLEAN _1126 = ___true();
	BOOLEAN _1127 = ___true();
	BOOLEAN _1128 = ___or(_1127, _1126);
	STRING _1129 = _1128 ? _1125 : _1124;
	ANY _1130 = box_STRING(_1129);
	___print(_1130);
	STRING _1131 = "FAIL: True OR False";
	STRING _1132 = "PASS: True OR False";
	BOOLEAN _1133 = ___false();
	BOOLEAN _1134 = ___true();
	BOOLEAN _1135 = ___or(_1134, _1133);
	STRING _1136 = _1135 ? _1132 : _1131;
	ANY _1137 = box_STRING(_1136);
	___print(_1137);
	STRING _1138 = "FAIL: False OR True";
	STRING _1139 = "PASS: False OR True";
	BOOLEAN _1140 = ___true();
	BOOLEAN _1141 = ___false();
	BOOLEAN _1142 = ___or(_1141, _1140);
	STRING _1143 = _1142 ? _1139 : _1138;
	ANY _1144 = box_STRING(_1143);
	___print(_1144);
	STRING _1145 = "PASS: False OR False";
	STRING _1146 = "FAIL: False OR False";
	BOOLEAN _1147 = ___false();
	BOOLEAN _1148 = ___false();
	BOOLEAN _1149 = ___or(_1148, _1147);
	STRING _1150 = _1149 ? _1146 : _1145;
	ANY _1151 = box_STRING(_1150);
	___print(_1151);
	STRING _1152 = "PASS: True XOR True";
	STRING _1153 = "FAIL: True XOR True";
	BOOLEAN _1154 = ___true();
	BOOLEAN _1155 = ___true();
	BOOLEAN _1156 = ___xor(_1155, _1154);
	STRING _1157 = _1156 ? _1153 : _1152;
	ANY _1158 = box_STRING(_1157);
	___print(_1158);
	STRING _1159 = "FAIL: True XOR False";
	STRING _1160 = "PASS: True XOR False";
	BOOLEAN _1161 = ___false();
	BOOLEAN _1162 = ___true();
	BOOLEAN _1163 = ___xor(_1162, _1161);
	STRING _1164 = _1163 ? _1160 : _1159;
	ANY _1165 = box_STRING(_1164);
	___print(_1165);
	STRING _1166 = "FAIL: False XOR True";
	STRING _1167 = "PASS: False XOR True";
	BOOLEAN _1168 = ___true();
	BOOLEAN _1169 = ___false();
	BOOLEAN _1170 = ___xor(_1169, _1168);
	STRING _1171 = _1170 ? _1167 : _1166;
	ANY _1172 = box_STRING(_1171);
	___print(_1172);
	STRING _1173 = "PASS: False XOR False";
	STRING _1174 = "FAIL: False XOR False";
	BOOLEAN _1175 = ___false();
	BOOLEAN _1176 = ___false();
	BOOLEAN _1177 = ___xor(_1176, _1175);
	STRING _1178 = _1177 ? _1174 : _1173;
	ANY _1179 = box_STRING(_1178);
	___print(_1179);
	STRING _1180 = "PASS: NOT True";
	STRING _1181 = "FAIL: NOT True";
	BOOLEAN _1182 = ___true();
	BOOLEAN _1183 = ___not(_1182);
	STRING _1184 = _1183 ? _1181 : _1180;
	ANY _1185 = box_STRING(_1184);
	___print(_1185);
	STRING _1186 = "PASS: NOT False";
	STRING _1187 = "PASS: NOT False";
	BOOLEAN _1188 = ___false();
	BOOLEAN _1189 = ___not(_1188);
	STRING _1190 = _1189 ? _1187 : _1186;
	ANY _1191 = box_STRING(_1190);
	___print(_1191);
}

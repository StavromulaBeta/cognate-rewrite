...
void fn12(BOX, BOOLEAN);
void fn11(NUMBER, BOOLEAN);
void fn9(void);
void fn8(NUMBER);
void fn7(NUMBER);
void fn6(BOX);
...
void fn14(void* env[0]) {
	NUMBER ___x_14 = *(NUMBER*)&env[0];
	BOOLEAN ____139 = *(BOOLEAN*)&env[1];
	fn11(___x_14,____139);
}

void fn13(void* env[0]) {
	BOX ___recurred_11 = *(BOX*)&env[0];
	BOOLEAN ____140 = *(BOOLEAN*)&env[1];
	fn12(___recurred_11,____140);
}

void fn12(BOX ___recurred_11, BOOLEAN ____140) {
	BOOLEAN _1099 = ____140;
	if (_1099) fn6(___recurred_11);
	else fn5(___recurred_11);
}

void fn11(NUMBER ___x_14, BOOLEAN ____139) {
	BOOLEAN _1100 = ____139;
	if (_1100) fn9();
	else fn8(___x_14);
}

void fn9(void) {
	STRING _1101 = "PASS: Binary recursion";
	ANY _1102 = box_STRING(_1101);
	___print(_1102);
}

void fn8(NUMBER ___x_14) {
	NUMBER _1103 = ___x_14;
	NUMBER _1104 = 1;
	NUMBER _1105 = ___P(_1104, _1103);
	NUMBER _1106 = 1;
	NUMBER _1107 = ___P(_1106, _1105);
	fn7(_1107);
}

void fn7(NUMBER _1108) {
	BOOLEAN ____139;
	NUMBER ___x_14;
	___x_14 = _1108;
	NUMBER _1109 = ___x_14;
	NUMBER _1110 = 1000;
	BOOLEAN _1111 = ___G(_1110, _1109);
	____139 = _1111;
	BLOCK _1112 = gc_malloc(5 * WORDSZ);
	_1112->fn = fn14;
	_1112->env[0] = *(void**)&___x_14;
	_1112->env[1] = *(void**)&____139;
	___do(_1112);
}

void fn6(BOX ___recurred_11) {
	BOOLEAN _1113 = ___true();
	BOX _1114 = ___recurred_11;
	ANY _1115 = box_BOOLEAN(_1113);
	___set(_1114, _1115);
}

void fn5(BOX ___recurred_11) {
	NUMBER _1116 = 0;
	ANY _1117 = box_NUMBER(_1116);
	fn4(___recurred_11,_1117);
}

void fn4(BOX ___recurred_11, ANY _1118) {
	BOOLEAN ____140;
	ANY ___n_12;
	___n_12 = _1118;
	ANY _1119 = ___n_12;
	NUMBER _1120 = 0;
	ANY _1121 = box_NUMBER(_1120);
	BOOLEAN _1122 = ___EE(_1121, _1119);
	____140 = _1122;
	BLOCK _1123 = gc_malloc(5 * WORDSZ);
	_1123->fn = fn13;
	_1123->env[0] = *(void**)&___recurred_11;
	_1123->env[1] = *(void**)&____140;
	___do(_1123);
}

void fn2(void) {
	STRING _1124 = "FAIL: Function shadowing 1";
	STRING _1125 = "PASS: Function shadowing 1";
	NUMBER _1126 = 5;
	NUMBER _1127 = 3;
	NUMBER _1128 = ___P(_1127, _1126);
	NUMBER _1129 = 8;
	ANY _1130 = box_NUMBER(_1129);
	ANY _1131 = box_NUMBER(_1128);
	BOOLEAN _1132 = ___EE(_1130, _1131);
	STRING _1133 = _1132 ? _1125 : _1124;
	ANY _1134 = box_STRING(_1133);
	___print(_1134);
}

void fn0(void) {
	BOX ___recurred_11;
	STRING _1135 = "FAIL: Function call and return";
	STRING _1136 = "PASS: Function call and return";
	NUMBER _1137 = 4;
	NUMBER _1138 = 1;
	NUMBER _1139 = ___P(_1138, _1137);
	NUMBER _1140 = 5;
	ANY _1141 = box_NUMBER(_1140);
	ANY _1142 = box_NUMBER(_1139);
	BOOLEAN _1143 = ___EE(_1141, _1142);
	STRING _1144 = _1143 ? _1136 : _1135;
	ANY _1145 = box_STRING(_1144);
	___print(_1145);
	BLOCK _1146 = gc_malloc(3 * WORDSZ);
	_1146->fn = fn23;
	___do(_1146);
	STRING _1147 = "FAIL: Function shadowing 2";
	STRING _1148 = "PASS: Function shadowing 2";
	NUMBER _1149 = 7;
	NUMBER _1150 = 1;
	NUMBER _1151 = ___P(_1150, _1149);
	NUMBER _1152 = 8;
	ANY _1153 = box_NUMBER(_1152);
	ANY _1154 = box_NUMBER(_1151);
	BOOLEAN _1155 = ___EE(_1153, _1154);
	STRING _1156 = _1155 ? _1148 : _1147;
	ANY _1157 = box_STRING(_1156);
	___print(_1157);
	BOOLEAN _1158 = ___false();
	ANY _1159 = box_BOOLEAN(_1158);
	BOX _1160 = ___box(_1159);
	___recurred_11 = _1160;
	NUMBER _1161 = 10;
	ANY _1162 = box_NUMBER(_1161);
	fn4(___recurred_11,_1162);
	STRING _1163 = "FAIL: Recursion";
	STRING _1164 = "PASS: Recursion";
	BOX _1165 = ___recurred_11;
	ANY _1166 = ___unbox(_1165);
	BOOLEAN _1167 = unbox_BOOLEAN(_1166);
	STRING _1168 = _1167 ? _1164 : _1163;
	ANY _1169 = box_STRING(_1168);
	___print(_1169);
	NUMBER _1170 = 1;
	fn7(_1170);
}

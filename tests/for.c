...
void fn3(BOX, ANY);
NUMBER fn2(void);
NUMBER fn1(NUMBER, NUMBER);
void fn0(void);

void fn8(void* env[0]) {
	ANY _526 = pop();
	ANY _527 = pop();
	NUMBER _528 = unbox_NUMBER(_526);
	NUMBER _529 = unbox_NUMBER(_527);
	NUMBER _530 = fn1(_528, _529);
	ANY _531 = box_NUMBER(_530);
	push(_531);
}

void fn7(void* env[0]) {
	NUMBER _532 = fn2();
	ANY _533 = box_NUMBER(_532);
	push(_533);
}

void fn6(void* env[0]) {
	BOX ___x_4 = *(BOX*)&env[0];
	ANY _534 = pop();
	fn3(___x_4,_534);
}
...
NUMBER fn4(void) {
	...
	NUMBER _540 = 2;
	NUMBER _541 = 1;
	ANY _542 = box_NUMBER(_537);
	push(_542);
	ANY _543 = box_NUMBER(_538);
	push(_543);
	ANY _544 = box_NUMBER(_539);
	push(_544);
	ANY _545 = box_NUMBER(_540);
	push(_545);
	return _541;
}

void fn3(BOX ___x_4, ANY _546) {
	BOX _547 = ___x_4;
	___set(_547, _546);
}
...
NUMBER fn2(void) {
	...
	NUMBER _551 = 2;
	NUMBER _552 = 1;
	ANY _553 = box_NUMBER(_548);
	push(_553);
	ANY _554 = box_NUMBER(_549);
	push(_554);
	ANY _555 = box_NUMBER(_550);
	push(_555);
	ANY _556 = box_NUMBER(_551);
	push(_556);
	return _552;
}

NUMBER fn1(NUMBER _557, NUMBER _558) {
	NUMBER _559 = ___M(_557, _558);
	return _559;
}
...
void fn0(void) {
	...
	BOX ___x_4;
	NUMBER _560 = 1;
	BLOCK _561 = gc_malloc(3 * WORDSZ);
	_561->fn = fn8;
	BLOCK _562 = gc_malloc(3 * WORDSZ);
	_562->fn = fn7;
	LIST _563 = ___list(_562);
	ANY _564 = box_NUMBER(_560);
	push(_564);
	___for(_563, _561);
	ANY _565 = pop();
	___r_3 = _565;
	STRING _566 = "FAIL: Computing 5! using for loop";
	STRING _567 = "PASS: Computing 5! using for loop";
	ANY _568 = ___r_3;
	NUMBER _569 = 120;
	ANY _570 = box_NUMBER(_569);
	BOOLEAN _571 = ___EE(_570, _568);
	STRING _572 = _571 ? _567 : _566;
	ANY _573 = box_STRING(_572);
	___print(_573);
	NUMBER _574 = 0;
	ANY _575 = box_NUMBER(_574);
	BOX _576 = ___box(_575);
	___x_4 = _576;
	BLOCK _577 = gc_malloc(4 * WORDSZ);
	_577->fn = fn6;
	_577->env[0] = *(void**)&___x_4;
	BLOCK _578 = gc_malloc(3 * WORDSZ);
	_578->fn = fn5;
	LIST _579 = ___list(_578);
	___for(_579, _577);
	STRING _580 = "FAIL: For loop executes in order";
	STRING _581 = "PASS: For loop executes in order";
	BOX _582 = ___x_4;
	ANY _583 = ___unbox(_582);
	NUMBER _584 = 5;
	ANY _585 = box_NUMBER(_584);
	BOOLEAN _586 = ___EE(_585, _583);
	STRING _587 = _586 ? _581 : _580;
	ANY _588 = box_STRING(_587);
	___print(_588);
}

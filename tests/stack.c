...
void fn12(void* env[0]);
void fn11(void* env[0]);
void fn10(void);
NUMBER fn9(void);
ANY fn8(ANY);
ANY fn7(ANY);
...
NUMBER fn9(void) {
	...
	NUMBER _1787 = 2;
	NUMBER _1788 = 1;
	ANY _1789 = box_NUMBER(_1786);
	push(_1789);
	ANY _1790 = box_NUMBER(_1787);
	push(_1790);
	return _1788;
}
...
void fn0(void) {
	BOOLEAN ___x_19;
	BOOLEAN ___y_20;
	STRING _1804 = "FAIL: Drop";
	STRING _1805 = "PASS: Drop";
	NUMBER _1806 = 2;
	NUMBER _1807 = 2;
	ANY _1808 = box_NUMBER(_1807);
	ANY _1809 = box_NUMBER(_1806);
	BOOLEAN _1810 = ___EE(_1808, _1809);
	STRING _1811 = _1810 ? _1805 : _1804;
	ANY _1812 = box_STRING(_1811);
	___print(_1812);
	STRING _1813 = "FAIL: Swap";
	STRING _1814 = "PASS: Swap";
	NUMBER _1815 = 6;
	NUMBER _1816 = 6;
	ANY _1817 = box_NUMBER(_1816);
	ANY _1818 = box_NUMBER(_1815);
	BOOLEAN _1819 = ___EE(_1817, _1818);
	STRING _1820 = _1819 ? _1814 : _1813;
	ANY _1821 = box_STRING(_1820);
	___print(_1821);
	STRING _1822 = "FAIL: Twin";
	STRING _1823 = "PASS: Twin";
	NUMBER _1824 = 4;
	NUMBER _1825 = 4;
	ANY _1826 = box_NUMBER(_1825);
	ANY _1827 = box_NUMBER(_1824);
	BOOLEAN _1828 = ___EE(_1826, _1827);
	STRING _1829 = _1828 ? _1823 : _1822;
	ANY _1830 = box_STRING(_1829);
	___print(_1830);
	STRING _1831 = "FAIL: Triplet";
	STRING _1832 = "PASS: Triplet";
	NUMBER _1833 = 7;
	NUMBER _1834 = 7;
	ANY _1835 = box_NUMBER(_1834);
	ANY _1836 = box_NUMBER(_1833);
	BOOLEAN _1837 = ___EE(_1835, _1836);
	STRING _1838 = _1837 ? _1832 : _1831;
	ANY _1839 = box_STRING(_1838);
	___print(_1839);
	STRING _1840 = "FAIL: Drop (runtime stack)";
	STRING _1841 = "PASS: Drop (runtime stack)";
	NUMBER _1842 = 2;
	NUMBER _1843 = 3;
	BLOCK _1844 = gc_malloc(3 * WORDSZ);
	_1844->fn = fn16;
	ANY _1845 = box_STRING(_1840);
	push(_1845);
	ANY _1846 = box_STRING(_1841);
	push(_1846);
	ANY _1847 = box_NUMBER(_1842);
	push(_1847);
	ANY _1848 = box_NUMBER(_1843);
	push(_1848);
	___do(_1844);
	NUMBER _1849 = 2;
	ANY _1850 = pop();
	ANY _1851 = box_NUMBER(_1849);
	BOOLEAN _1852 = ___EE(_1851, _1850);
	ANY _1853 = pop();
	ANY _1854 = pop();
	ANY _1855 = _1852 ? _1853 : _1854;
	___print(_1855);
	STRING _1856 = "FAIL: Swap (runtime stack)";
	STRING _1857 = "PASS: Swap (runtime stack)";
	NUMBER _1858 = 5;
	NUMBER _1859 = 6;
	BLOCK _1860 = gc_malloc(3 * WORDSZ);
	_1860->fn = fn15;
	ANY _1861 = box_STRING(_1856);
	push(_1861);
	ANY _1862 = box_STRING(_1857);
	push(_1862);
	ANY _1863 = box_NUMBER(_1858);
	push(_1863);
	ANY _1864 = box_NUMBER(_1859);
	push(_1864);
	___do(_1860);
	ANY _1865 = pop();
	NUMBER _1866 = 6;
	ANY _1867 = pop();
	ANY _1868 = box_NUMBER(_1866);
	BOOLEAN _1869 = ___EE(_1868, _1867);
	ANY _1870 = pop();
	ANY _1871 = pop();
	ANY _1872 = _1869 ? _1870 : _1871;
	___print(_1872);
	STRING _1873 = "FAIL: Twin (runtime stack)";
	STRING _1874 = "PASS: Twin (runtime stack)";
	NUMBER _1875 = 4;
	BLOCK _1876 = gc_malloc(3 * WORDSZ);
	_1876->fn = fn14;
	ANY _1877 = box_STRING(_1873);
	push(_1877);
	ANY _1878 = box_STRING(_1874);
	push(_1878);
	ANY _1879 = box_NUMBER(_1875);
	push(_1879);
	___do(_1876);
	ANY _1880 = pop();
	NUMBER _1881 = 4;
	ANY _1882 = pop();
	ANY _1883 = box_NUMBER(_1881);
	BOOLEAN _1884 = ___EE(_1883, _1882);
	ANY _1885 = pop();
	ANY _1886 = pop();
	ANY _1887 = _1884 ? _1885 : _1886;
	___print(_1887);
	STRING _1888 = "FAIL: Triplet (runtime stack)";
	STRING _1889 = "PASS: Triplet (runtime stack)";
	NUMBER _1890 = 7;
	BLOCK _1891 = gc_malloc(3 * WORDSZ);
	_1891->fn = fn13;
	ANY _1892 = box_STRING(_1888);
	push(_1892);
	ANY _1893 = box_STRING(_1889);
	push(_1893);
	ANY _1894 = box_NUMBER(_1890);
	push(_1894);
	___do(_1891);
	ANY _1895 = pop();
	ANY _1896 = pop();
	NUMBER _1897 = 7;
	ANY _1898 = pop();
	ANY _1899 = box_NUMBER(_1897);
	BOOLEAN _1900 = ___EE(_1899, _1898);
	ANY _1901 = pop();
	ANY _1902 = pop();
	ANY _1903 = _1900 ? _1901 : _1902;
	___print(_1903);
	NUMBER _1904 = 3;
	NUMBER _1905 = 2;
	NUMBER _1906 = 1;
	ANY _1907 = box_NUMBER(_1904);
	push(_1907);
	ANY _1908 = box_NUMBER(_1905);
	push(_1908);
	ANY _1909 = box_NUMBER(_1906);
	push(_1909);
	LIST _1910 = ___stack();
	BLOCK _1911 = gc_malloc(3 * WORDSZ);
	_1911->fn = fn12;
	LIST _1912 = ___list(_1911);
	ANY _1913 = box_LIST(_1912);
	ANY _1914 = box_LIST(_1910);
	BOOLEAN _1915 = ___EE(_1913, _1914);
	___x_19 = _1915;
	ANY _1916 = pop();
	ANY _1917 = pop();
	ANY _1918 = pop();
	STRING _1919 = "FAIL: Stack as list";
	STRING _1920 = "PASS: Stack as list";
	BOOLEAN _1921 = ___x_19;
	STRING _1922 = _1921 ? _1920 : _1919;
	ANY _1923 = box_STRING(_1922);
	___print(_1923);
	NUMBER _1924 = 5;
	NUMBER _1925 = 4;
	NUMBER _1926 = 3;
	NUMBER _1927 = 2;
	NUMBER _1928 = 1;
	ANY _1929 = box_NUMBER(_1924);
	push(_1929);
	ANY _1930 = box_NUMBER(_1925);
	push(_1930);
	ANY _1931 = box_NUMBER(_1926);
	push(_1931);
	ANY _1932 = box_NUMBER(_1927);
	push(_1932);
	ANY _1933 = box_NUMBER(_1928);
	push(_1933);
	___clear();
	LIST _1934 = ___stack();
	BLOCK _1935 = gc_malloc(3 * WORDSZ);
	_1935->fn = fn11;
	LIST _1936 = ___list(_1935);
	ANY _1937 = box_LIST(_1936);
	ANY _1938 = box_LIST(_1934);
	BOOLEAN _1939 = ___EE(_1937, _1938);
	___y_20 = _1939;
	STRING _1940 = "FAIL: Clearing the stack";
	STRING _1941 = "PASS: Clearing the stack";
	BOOLEAN _1942 = ___y_20;
	STRING _1943 = _1942 ? _1941 : _1940;
	ANY _1944 = box_STRING(_1943);
	___print(_1944);
}

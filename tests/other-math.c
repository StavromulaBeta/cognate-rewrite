...
void fn0(void) {
	STRING _220 = "FAIL: exp";
	STRING _221 = "PASS: exp";
	NUMBER _222 = 0;
	NUMBER _223 = ___exp(_222);
	NUMBER _224 = 1;
	ANY _225 = box_NUMBER(_224);
	ANY _226 = box_NUMBER(_223);
	BOOLEAN _227 = ___EE(_225, _226);
	STRING _228 = _227 ? _221 : _220;
	ANY _229 = box_STRING(_228);
	___print(_229);
	STRING _230 = "FAIL: Log base e";
	STRING _231 = "PASS: Log base e";
	NUMBER _232 = 1;
	NUMBER _233 = ___ln(_232);
	NUMBER _234 = 0;
	ANY _235 = box_NUMBER(_234);
	ANY _236 = box_NUMBER(_233);
	BOOLEAN _237 = ___EE(_235, _236);
	STRING _238 = _237 ? _231 : _230;
	ANY _239 = box_STRING(_238);
	___print(_239);
	STRING _240 = "FAIL: Log";
	STRING _241 = "PASS: Log";
	NUMBER _242 = 100;
	NUMBER _243 = 10;
	NUMBER _244 = ___log(_243, _242);
	NUMBER _245 = 2;
	ANY _246 = box_NUMBER(_245);
	ANY _247 = box_NUMBER(_244);
	BOOLEAN _248 = ___EE(_246, _247);
	STRING _249 = _248 ? _241 : _240;
	ANY _250 = box_STRING(_249);
	___print(_250);
}

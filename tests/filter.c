...
void fn20(void* env[0]) {
	NUMBER _1257 = fn3();
	ANY _1258 = box_NUMBER(_1257);
	push(_1258);
}

void fn19(void* env[0]) {
	ANY _1259 = pop();
	NUMBER _1260 = unbox_NUMBER(_1259);
	BOOLEAN _1261 = fn4(_1260);
	ANY _1262 = box_BOOLEAN(_1261);
	push(_1262);
}
...
void fn17(void* env[0]) {
	ANY _1263 = pop();
	NUMBER _1264 = unbox_NUMBER(_1263);
	BOOLEAN _1265 = fn6(_1264);
	ANY _1266 = box_BOOLEAN(_1265);
	push(_1266);
}

void fn16(void* env[0]) {
	NUMBER _1267 = fn7();
	ANY _1268 = box_NUMBER(_1267);
	push(_1268);
}

void fn15(void* env[0]) {
	BOX ___x_15 = *(BOX*)&env[0];
	ANY _1269 = pop();
	BOOLEAN _1270 = fn8(___x_15,_1269);
	ANY _1271 = box_BOOLEAN(_1270);
	push(_1271);
}

void fn14(void* env[0]) {
	NUMBER _1272 = fn9();
	ANY _1273 = box_NUMBER(_1272);
	push(_1273);
}
...
NUMBER fn11(void) {
	...
	NUMBER _1277 = 3;
	NUMBER _1278 = 1;
	ANY _1279 = box_NUMBER(_1276);
	push(_1279);
	ANY _1280 = box_NUMBER(_1277);
	push(_1280);
	return _1278;
}
...
NUMBER fn9(void) {
	NUMBER _1281 = 4;
	NUMBER _1282 = 2;
	ANY _1283 = box_NUMBER(_1281);
	push(_1283);
	return _1282;
}

BOOLEAN fn8(BOX ___x_15, ANY _1284) {
	BOOLEAN ___x_140;
	BOX _1285 = ___x_15;
	ANY _1286 = ___unbox(_1285);
	BOOLEAN _1287 = unbox_BOOLEAN(_1286);
	___x_140 = _1287;
	BOOLEAN _1288 = ___x_140;
	BOOLEAN _1289 = ___x_140;
	BOOLEAN _1290 = ___not(_1289);
	BOX _1291 = ___x_15;
	ANY _1292 = box_BOOLEAN(_1290);
	___set(_1291, _1292);
	return _1288;
}
...
NUMBER fn7(void) {
	...
	NUMBER _1296 = 2;
	NUMBER _1297 = 1;
	ANY _1298 = box_NUMBER(_1293);
	push(_1298);
	ANY _1299 = box_NUMBER(_1294);
	push(_1299);
	ANY _1300 = box_NUMBER(_1295);
	push(_1300);
	ANY _1301 = box_NUMBER(_1296);
	push(_1301);
	return _1297;
}

BOOLEAN fn6(NUMBER _1302) {
	NUMBER _1303 = 2;
	NUMBER _1304 = ___modulo(_1303, _1302);
	NUMBER _1305 = 0;
	ANY _1306 = box_NUMBER(_1305);
	ANY _1307 = box_NUMBER(_1304);
	BOOLEAN _1308 = ___EE(_1306, _1307);
	return _1308;
}
...
BOOLEAN fn4(NUMBER _1309) {
	NUMBER _1310 = 2;
	NUMBER _1311 = ___modulo(_1310, _1309);
	NUMBER _1312 = 0;
	ANY _1313 = box_NUMBER(_1312);
	ANY _1314 = box_NUMBER(_1311);
	BOOLEAN _1315 = ___EE(_1313, _1314);
	return _1315;
}
...
NUMBER fn3(void) {
	...
	NUMBER _1319 = 2;
	NUMBER _1320 = 1;
	ANY _1321 = box_NUMBER(_1316);
	push(_1321);
	ANY _1322 = box_NUMBER(_1317);
	push(_1322);
	ANY _1323 = box_NUMBER(_1318);
	push(_1323);
	ANY _1324 = box_NUMBER(_1319);
	push(_1324);
	return _1320;
}
...
void fn0(void) {
	...
	BOX ___x_15;
	LIST ___odds_16;
	BLOCK _1325 = gc_malloc(3 * WORDSZ);
	_1325->fn = fn20;
	LIST _1326 = ___list(_1325);
	BLOCK _1327 = gc_malloc(3 * WORDSZ);
	_1327->fn = fn19;
	LIST _1328 = ___filter(_1327, _1326);
	___evens_13 = _1328;
	BLOCK _1329 = gc_malloc(3 * WORDSZ);
	_1329->fn = fn18;
	LIST _1330 = ___list(_1329);
	BLOCK _1331 = gc_malloc(3 * WORDSZ);
	_1331->fn = fn17;
	LIST _1332 = ___filter(_1331, _1330);
	___empty_14 = _1332;
	BOOLEAN _1333 = ___true();
	ANY _1334 = box_BOOLEAN(_1333);
	BOX _1335 = ___box(_1334);
	___x_15 = _1335;
	BLOCK _1336 = gc_malloc(3 * WORDSZ);
	_1336->fn = fn16;
	LIST _1337 = ___list(_1336);
	BLOCK _1338 = gc_malloc(4 * WORDSZ);
	_1338->fn = fn15;
	_1338->env[0] = *(void**)&___x_15;
	LIST _1339 = ___filter(_1338, _1337);
	___odds_16 = _1339;
	STRING _1340 = "FAIL: Filtering a list";
	STRING _1341 = "PASS: Filtering a list";
	BLOCK _1342 = gc_malloc(3 * WORDSZ);
	_1342->fn = fn14;
	LIST _1343 = ___list(_1342);
	LIST _1344 = ___evens_13;
	ANY _1345 = box_LIST(_1344);
	ANY _1346 = box_LIST(_1343);
	BOOLEAN _1347 = ___EE(_1345, _1346);
	STRING _1348 = _1347 ? _1341 : _1340;
	ANY _1349 = box_STRING(_1348);
	___print(_1349);
	STRING _1350 = "FAIL: Filtering an empty list";
	STRING _1351 = "PASS: Filtering an empty list";
	BLOCK _1352 = gc_malloc(3 * WORDSZ);
	_1352->fn = fn13;
	LIST _1353 = ___list(_1352);
	LIST _1354 = ___empty_14;
	ANY _1355 = box_LIST(_1354);
	ANY _1356 = box_LIST(_1353);
	BOOLEAN _1357 = ___EE(_1355, _1356);
	STRING _1358 = _1357 ? _1351 : _1350;
	ANY _1359 = box_STRING(_1358);
	___print(_1359);
	STRING _1360 = "FAIL: Filtering a list in order";
	STRING _1361 = "PASS: Filtering a list in order";
	BLOCK _1362 = gc_malloc(3 * WORDSZ);
	_1362->fn = fn12;
	LIST _1363 = ___list(_1362);
	LIST _1364 = ___odds_16;
	ANY _1365 = box_LIST(_1364);
	ANY _1366 = box_LIST(_1363);
	BOOLEAN _1367 = ___EE(_1365, _1366);
	STRING _1368 = _1367 ? _1361 : _1360;
	ANY _1369 = box_STRING(_1368);
	___print(_1369);
}
